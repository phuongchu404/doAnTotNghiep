...
<body class="">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <div class="d-flex ">
                                    <a href="${base}/bounty-sneaker/admin/category-blog.html" class="btn_back_list"><i
                                            class="fa fa-arrow-left"></i></a> &nbsp
                                    <h3 class="title-5" id="title-page-update-add">Thêm danh mục blog</h3>
                                </div>
                                <div class="">
    ...
    <script src="${base }/manager/script/categoryBlog/save.js"></script>
</body>
